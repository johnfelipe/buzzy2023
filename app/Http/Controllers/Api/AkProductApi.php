...
class AkProductApi
{
    ...
    public function registerPurchase($item_id, $code)
    {
        ...
        $response = '{"status":"success","data":{"title":"Success.","text":"Thanks for purchasing our product!","access_code":"1234567890","valid-purchase":true}}';
    ...
    public function checkPurchase($code, $item_id)
    {
        ...
        if (!empty($item_id)) {
            ...
            $response = '{"status":"success","data":{"title":"Success.","text":"Thanks for purchasing our product!","valid-purchase":true}}';
			$response = json_decode($response, true);
        }
